...
export default function SellerHistory({
  ...
  return (
    <>
      <Head>
        <title>Seller History | HeelBid</title>
        <meta
          name="description"
          content="Track all items you've sold on HeelBid. View your full seller history with listings, prices, and auction outcomes."
        />
      </Head>
